...
/**
 * Cost Center / Department History body. Rendered both by the standalone
 * page and as a Finance dashboard tab so history lives next to related
 * finance data without duplicating the UI.
 */
export function CostCenterHistoryContent() {
