...
AS $function$
  ...
  -- Anything with money already paid against it, or already allocated to an
  -- active payment batch, leaves this queue: part-paid items live in the
  -- "Partially Paid" view with their outstanding balance, batched items in
  -- the Batches tab. Prevents backlog and duplicate batching.
